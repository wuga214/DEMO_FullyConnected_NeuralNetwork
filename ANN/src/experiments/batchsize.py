...
for minibatch in batchsizes:
    ...
    NN.Train(features_normalized, targets, test_normalized, test_targets, 10e-5, minibatch[0], 50, 0.001)
...
for i in range(len(results)):
    ...
    legends.append(x)
plt.legend(x,['500','1000'])
plt.title('Error curve of different batch size')
plt.show()
